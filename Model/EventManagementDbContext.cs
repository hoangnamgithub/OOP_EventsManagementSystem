...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        optionsBuilder.UseSqlServer(
            "Data Source=.\\sqlexpress;Initial Catalog=EventManagementDB;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False"
        );
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Engaged>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.AccountId, e.EventId }, "UQ__engaged__24952DBE6CDBB78C")
                .IsUnique();
        ...
        modelBuilder.Entity<Equipment>(entity =>
        {
            ...
            entity.Property(e => e.Condition).HasMaxLength(100).HasColumnName("condition");
            entity.Property(e => e.EquipNameId).HasColumnName("equip_name_id");

            entity
                .HasOne(d => d.EquipName)
        ...
        modelBuilder.Entity<EquipmentName>(entity =>
        {
            ...
            entity.Property(e => e.EquipNameId).HasColumnName("equip_name_id");
            entity
                .Property(e => e.EquipCost)
                .HasColumnType("decimal(10, 2)")
                .HasColumnName("equip_cost");
            entity.Property(e => e.EquipName).HasMaxLength(100).HasColumnName("equip_name");
            entity.Property(e => e.EquipTypeId).HasColumnName("equip_type_id");

            entity
                .HasOne(d => d.EquipType)
        ...
        modelBuilder.Entity<EquipmentType>(entity =>
        {
            ...
            entity.Property(e => e.EquipTypeId).HasColumnName("equip_type_id");
            entity.Property(e => e.TypeName).HasMaxLength(100).HasColumnName("type_name");
        });
        ...
        modelBuilder.Entity<Event>(entity =>
        {
            ...
            entity.Property(e => e.EventName).HasMaxLength(100).HasColumnName("event_name");
        ...
        modelBuilder.Entity<Genre>(entity =>
        {
            ...
            entity.Property(e => e.Genre1).HasMaxLength(100).HasColumnName("genre");
        });
        ...
        modelBuilder.Entity<IsSponsor>(entity =>
        {
            ...
            entity
                .HasIndex(
                    ...
                    "UQ__is_spons__B494436DE506E4E0"
                )
                .IsUnique();
        ...
        modelBuilder.Entity<Need>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.RoleId, e.EventId }, "UQ__need__143E6ABF7DC6B535")
                .IsUnique();
        ...
        modelBuilder.Entity<Performer>(entity =>
        {
            ...
            entity.Property(e => e.ContactDetail).HasMaxLength(50).HasColumnName("contact_detail");
            entity.Property(e => e.FullName).HasMaxLength(100).HasColumnName("full_name");
        });
        ...
        modelBuilder.Entity<Permission>(entity =>
        {
            ...
            entity.Property(e => e.PermissionId).HasColumnName("permission_id");
            entity.Property(e => e.Permission1).HasMaxLength(100).HasColumnName("permission");
        });
        ...
        modelBuilder.Entity<Required>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.EventId, e.EquipNameId }, "UQ__required__734F38E9FD3CBBF6")
                .IsUnique();
        ...
        modelBuilder.Entity<Show>(entity =>
        {
            ...
            entity.Property(e => e.Cost).HasColumnType("decimal(10, 2)").HasColumnName("cost");
            entity.Property(e => e.GenreId).HasColumnName("genre_id");
            entity.Property(e => e.PerformerId).HasColumnName("performer_id");
            entity.Property(e => e.ShowName).HasMaxLength(100).HasColumnName("show_name");
        ...
        modelBuilder.Entity<ShowSchedule>(entity =>
        {
            ...
            entity
                .HasIndex(e => new { e.ShowId, e.EventId }, "UQ__show_sch__49A0D86FAF7F81B0")
                .IsUnique();
        ...
        modelBuilder.Entity<Sponsor>(entity =>
        {
            ...
            entity.Property(e => e.SponsorName).HasMaxLength(100).HasColumnName("sponsor_name");
        });
        ...
        modelBuilder.Entity<SponsorTier>(entity =>
        {
            ...
            entity.Property(e => e.SponsorTierId).HasColumnName("sponsor_tier_id");
            entity.Property(e => e.TierName).HasMaxLength(100).HasColumnName("tier_name");
        });
        ...
        modelBuilder.Entity<Venue>(entity =>
        {
            ...
            entity.Property(e => e.Cost).HasColumnType("decimal(10, 2)").HasColumnName("cost");
            entity.Property(e => e.VenueName).HasMaxLength(100).HasColumnName("venue_name");
        });
